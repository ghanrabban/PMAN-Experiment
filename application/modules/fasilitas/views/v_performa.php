   ...
   <div class="row align-items-end">
      ...
      <div class="col-lg-4">
         <div class="page-header-breadcrumb">
            <!-- Tombol Kembali -->
            <a onclick="window.history.go(-1); return false;" class="btn btn-primary float-right">
      ...
      $.ajax({
         ...
         success: function(r) {
            ...
            //  script untuk menampilkan data pada label perform fasilitas
             ...
             $('#status').html(json['fasilitas']['status']);
            console.log(json['fasilitas']['status']);
             jQuery.each(json['tabel-data'], function (i, val) {
               ...
               //    //console.log("asdasd");
               //  }
               opt = `<a href="<?=base_url()?>/perangkat/performPerangkat/${val['id_perangkat']}"><button class="btn waves-effect waves-light btn-primary btn-outline-primary btn-icon" ><i class="feather icon-eye"></i></button></a>`;
                row += `<tr>
                            <td>${no++}</td>
                            <td>${val['foto'] || ''}</td>
                            <td>${val['nama_jp'] || ''}</td>
    ...
    row +=                 `<div class="row p-t-20 p-b-10">
                    ...
                    row +=`<div class="row p-t-20 p-b-10">
                                            ...
                                            <div class="col p-l-5">
                                               ...
                                               <small class="text-muted m-b-0">`+val['create_date']+` sampai `+val['end_time']+`</small>
                                            </div>
                                         </div>`;
                               });
