     ...
     success: function(r){
      ...
      jQuery.each(json, function( i, val ) {
         ...
         jQuery.each(val['data'], function( ii, vall ) {
                  ...
                  bar+=`<div class="col-md-${col}">
                     <div class="card">
                        <div class="card-body">
                           <div id="grafik_bar_${i}${ii}" style=" height: 450px;"></div>
                        </div>
                     </div>
                  </div>`;
      ...
      jQuery.each(json, function( i, val ) {
         jQuery.each(val['data'], function( ii, vall ) {
            // console.log(document.getElementById(grafik));
                  drawBasic('grafik_bar_'+i+ii,vall['perfome'],val['kode_unit'],vall['nama_terminal'],vall['id'],val['id_unit'],val['warna']); 
           });
      });
...
function drawBasic(id,data_fasilitas,unit,nama_terminal,id_terminal,id_unit,warna) {
 console.log("Terminal"+nama_terminal);
   var jsonData = data_fasilitas;
   var nama_terminal = (nama_terminal == null ? unit+' All Terminal': nama_terminal);
