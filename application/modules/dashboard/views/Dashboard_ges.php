            ...
            <div class="row">
                              ...
                              <div class="row pp-main "  >
                                 <div class="col-xl-4 col-md-6">
                                    <div class="pp-cont">
                                       ...
                                       <div class="row align-items-center m-b-15">
                                          <div class="col-auto">
                                             <p class="m-b-0">Total Kegiatan PM</p>
                                          </div>
                                          <div class="col text-end">
                                 ...
                                 <div class="col-xl-4 col-md-6">
                                    <div class="pp-cont">
                                       ...
                                       <div class="row align-items-center m-b-15">
                                          <div class="col-auto">
                                             <p class="m-b-0">Total Kegiatan CM</p>
                                          </div>
                                          <div class="col text-end">
                                 ...
                                 <div class="col-xl-4 col-md-6">
                                    <div class="pp-cont">
                                       ...
                                       <div class="row align-items-center m-b-15">
                                          <div class="col-auto">
                                             <p class="m-b-0">Gangguan Terbanyak</p>
                                          </div>
                                          <div class="col text-end">
               ...
               <div class="col-xl-3 col-md-6">
                  ...
                  <div class="card latest-update-card">
                     <div class="card-header">
                        <h5>Log Book <?=sess()['unit_kode']?></h5>
                     </div>
                     <div class="card-block scroll-data">
                        <div class="scroll-widget">
                           <div class="latest-update-box" id="list_logBook">
...
<script>
                   ...
                   success: function(response) {
                       ...
                       $.each(response['data'], function(index, logbook) {
                        logbookHtml +=`<div class="row p-t-20 p-b-30">
                                       <div class="col-auto text-end update-meta p-r-0">
                                          <i class="feather ${logbook['ico']} bg-c-blue update-icon"></i>
                                       </div>
                                       <div class="col p-l-5">
                                          <a href="${logbook['url']}">
                                             <h6> ${logbook['tittle']}</h6>
                                          </a>
                                          <p class="text-muted m-b-0">${logbook['note']}</p>
                                       </div>
                                    </div>`;
                       });
                       // Menampilkan data logbook di dalam elemen dengan ID logbook_data
                       $('#list_logBook').html(logbookHtml);
                   },
   ...
   function GetOffFasility(Catagory){
   ...
   $.ajax({
     url: "<?=base_url()?>dashboard/PerfomanceFasility/GetOffFasilityByname",
     type: 'post',
     data: formData,
     contentType: false,
     processData: false,
   ...
   $.ajax({
     url: "<?=base_url()?>dashboard/fasilitasdetail/",
     type: 'post',
     // data: formData,
     contentType: false,
     processData: false,
     ...
     success: function(r){
      ...
      jQuery.each(json['data'], function( i, val ) {
                console.log('bar_chart',json['unit'],val['nama_terminal']);
            //   drawBasic_detail('bar_chart',val['perfome'],json['unit'],val['nama_terminal'],val['id'],json['id_unit']); 
       
      });
        GrafikPerfomanceUnit(json['grafik'])
        PIEChart(json['perfomance']);
...
function GrafikPerfomanceUnit(data) {
    ...
    if (!data || !data.data || !data.name) {
        console.warn('GrafikPerfomanceUnit: data tidak valid', data);
        return;
    }

    if ($('#bar_chart').length === 0) return;
    ...
    let option = {
        title: {
            text: 'Performance Unit ' + (data.unit ?? ''),
   ...
   function PIEChart(data) {
    ...
    if (!data) {
        console.warn('PIEChart: data kosong');
        return;
    }
    ...
    /* =========================
       PIE FASILITAS
    ========================== */
    if ($('#chart_fasilitas').length > 0 && data.fasilitas?.length > 0) {

        let domFasilitas = document.getElementById('chart_fasilitas');

        // destroy chart lama
        let chartFasilitas = echarts.getInstanceByDom(domFasilitas);
        if (chartFasilitas) chartFasilitas.dispose();

        chartFasilitas = echarts.init(domFasilitas, 'light');

        let optionFasilitas = {
            title: {
                text: 'Performance Fasilitas',
                left: 'center'
            },
            tooltip: {
                trigger: 'item'
        ...
        chartFasilitas.setOption(optionFasilitas);
        chartFasilitas.resize();

        chartFasilitas.off('click');
        chartFasilitas.on('click', function (params) {
            if (params?.name) {
                GetFasilityOFF(params.name);
            }
        });
    }
    ...
    /* =========================
       PIE PERANGKAT
    ========================== */
    if ($('#chart_perangkat').length > 0 && data.catagory?.length > 0) {

        let domPerangkat = document.getElementById('chart_perangkat');

        let chartPerangkat = echarts.getInstanceByDom(domPerangkat);
        if (chartPerangkat) chartPerangkat.dispose();

        chartPerangkat = echarts.init(domPerangkat, 'light');

        let optionPerangkat = {
            title: {
                text: 'Persentase Jumlah Perangkat',
                left: 'center'
            },
            tooltip: {
                trigger: 'item',
        ...
        chartPerangkat.setOption(optionPerangkat);
        chartPerangkat.resize();
    }
}
