...
function LoadData() {
    ...
    function AddData(){
      ...
      $('#requestModal').find('.modal-title').html('Tambah Merk Baru');   
...
function UpdateData(form,id) {
    ...
    $.ajax({
        url: "<?=base_url()?>merk/UpdateData/"+id,  
        type: 'post',
        data: formData,
