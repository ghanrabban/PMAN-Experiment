...
<script>
   ...
   var end = "";
      ...
      function FilterData(){
         ...
         $.ajax({
               url: "<?=base_url()?>jenis_perangkat/LoadData",
               type: 'post',
               // data: formData,
               contentType: false,
               processData: false,
               ...
               success: function(r){
                  ...
                  jQuery.each(json, function( i, val ) {
                     ...
                     if (val['id_unit'] == 0) {
                        ...
                        btn = ` <button class="btn waves-effect waves-light btn-danger btn-icon" onclick="confirmDelete(`+val['id_jenisperangkat']+`, '` + val['nama'] + `')"><i class="fa fa-trash"></i></button>`;   
                     }
                     header_table +=`<tr >
                                       ...
                                       <td class="center">
                                          <button class="btn waves-effect waves-light btn-primary btn-icon" onclick="EditData(`+val['id_jenisperangkat']+`)"><i class="feather icon-edit"></i></button>
    ...
    function EditData(id){
      ...
      $.ajax({
               url: "<?=base_url()?>jenis_perangkat/EditData/"+id,
               type: 'post',
               // data: formData,
               contentType: false,
               processData: false,
    ...
    function Delete(id){
      ...
      $.ajax({
         url:  '<?=base_url('jenis_perangkat/')?>Delete/'+id,
    ...
    function UpdateData(f,id){
      ...
      $.ajax({
         url:  '<?=base_url('jenis_perangkat/')?>Update/'+id,
   ...
   function SaveData(f){
      ...
      // formData.append('id', id);
      $.ajax({
         url:  '<?=base_url('jenis_perangkat/')?>SaveData/',
