                  ...
                  jQuery.each(json['unit'], function( i, val ) {
                     ...
                     header_table +=`<tr >
                                       ...
                                       <td style="text-align: center;">
                                          ...
                                          <button class="btn waves-effect waves-light btn-danger btn-icon" onclick="Delete(`+val['id_unit']+`)"><i class="fa fa-trash"></i></button>
                                       </td>
                                    </tr>`;
                  });
...
//  function Delete(id){
   ...
   // }
      ...
      // function MenuParent(){
      //    $.ajax({
      //          url: "<?=base_url()?>Unit/LoadDataParent",
      //          type: 'post',
      //          // data: formData,
      //          contentType: false,
      //          processData: false,
      ...
      //                row +=`  <option value="`+val['id_unit']+`">`+val['kode_unit']+val['name_unit']`</option>`;
      //             });
      //             $('#parent').html(row);
      //             hide ();
      //          }, error: function(){
