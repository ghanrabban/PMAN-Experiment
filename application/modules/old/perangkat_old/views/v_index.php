         ...
         <form onsubmit="return SaveGroup(this)">
            <div class="modal-body">
               ...
               <div class="form-group row">
                  <div class="col-md-6">
                     <div class="row">
                        <label class="col-md-4 col-form-label">merk_id</label>
                        <div class="col-md-8">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-md-6">
                     <div class="row">
                        <label class="col-md-4 col-form-label"> Sublokasi</label>
                        <div class="col-md-8">
         ...
         <form onsubmit="return Update()">
            <div class="modal-body">
               <div class="form-group row">
                  ...
                  <label class="col-sm-4 col-form-label" id="jenis_perangkat">444</label>
               </div>
               <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Nama Perangkat</label>
                  <label class="col-sm-1 col-form-label">:</label>
                  <label class="col-sm-4 col-form-label" id="nama_perangkat">444</label>
               </div>
               <div class="form-group row">
                  <label class="col-sm-2 col-form-label">SN</label>
                  <label class="col-sm-1 col-form-label">:</label>
                  <label class="col-sm-4 col-form-label" id="SN_perangkat">444</label>
               </div>
               <hr>
               <div class="row">
                  <div class="col-md-10">
                  ...
                  <div class="col-md-12">
                     <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Property Perangkat</label>
                        <div class="col-md-6">
                           <select class="form-control" id="idmaster_detail_perangkat" name="idmaster_detail_perangkat">
                              <option value=""></option>
                           </select>
                        </div>
                     </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <table class="table table-condensed table-striped" id="tabel-data-detail">
                        <thead>
                           <tr>
                              <th>Field</th>
                              <th>Ketarangan</th>
         ...
         success: function(r) {
             ...
             jQuery.each(json['perangkat'], function(i, val) {
              ...
              if (val['status'] == 0) {
               ...
               <button class="btn waves-effect waves-light btn-primary btn-outline-primary btn-icon" onclick="ProsesData(` + val['id_perangkat'] + `)"><i class="fa fa-gear"></i></button>
