                     ...
                     <div class="col-md-12">
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                                 ...
                                 <option ></option>
                                 <option value="UploadHarian">UploadHarian</option>
                                 <option value="UploadMingguanSA" >Upload Mingguan SA</option>
                                 <option value="UploadBulananSWITCH" >Upload Bulanan SWITCH</option>
                                 <option value="UploadSemesterPSN">UploadSemester PSN</option>
                                 <option value="UploadSemesterSWITCH">UploadSemester SWITCH</option>
                                 <option value="UploadTriwulanPSN">UploadTriwulan PSN</option>
                                 <option value="UploadTriwulanSERVER">Upload Triwulan SERVER</option> 
                                 <option value="UploadTriwulanWORKSTATION">UploadTriwulan WORKSTATION </option>
                                 </select>
