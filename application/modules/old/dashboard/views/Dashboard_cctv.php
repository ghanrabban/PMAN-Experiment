            ...
            <div class="row">
                     ...
                     <div class="col-xl-6 col-md-6">
                        <div class="card">
                           <div class="card-header">
                              <h5>Performansi Fasilitas SSIT</h5>
                           </div>
                                          ...
                                          <td>
                                             <div class="d-inline-block align-middle">
                                                ...
                                                <div class="d-inline-block">
                                                   <h6>Monitor - SN000</h6>
                                                   <p class="text-muted m-b-0">SSIT Checkin 23</p>
                                                </div>
                                             </div>
                                          </td>
                                          <td class="text-end">
                                       ...
                                       <tr>
                                          <td>
                                             <div class="d-inline-block align-middle">
                                                ...
                                                <div class="d-inline-block">
                                                   <h6>Mini PC - SN000</h6>
                                                   <p class="text-muted m-b-0">SSIT General Checkin 1A</p>
                                                </div>
                                             </div>
                                          </td>
                                          <td class="text-end">
               ...
               <div class="col-xl-3 col-md-6">
                  ...
                  <div class="card new-cust-card">
                     ...
                     <div class="card-block scroll-data" id="list-pm">
               ...
               <div class="col-xl-3 col-md-6">
                  <div class="card new-cust-card">
                     <div class="card-header">
                        <h5>Personil Shift Berikutnya</h5>
                        <div class="card-header-right">
                        </div>
                     </div>
                     <div class="card-block scroll-data">
               ...
               <div class="col-md-12">
                  <div class="card table-card">
                     <div class="card-header">
                        <h5>Rekapitulasi Kondisi Fasilitas SSIT</h5>
                     </div>
                     <div class="card-block">
                        <div class="table-responsive">
