                           ...
                           <div class="row">
                              ...
                              <div class="col-xs-12 col-sm-12 col-sm-12 col-md-3">
                                 <div class="dataTables_length" id="complex-dt_length">
                                    <label>
                                       Filter By 
                                       <select name="complex-dt_length" aria-controls="complex-dt" class="form-control input-sm" id="filter_unit_user">
                                       <option ></option>
...
<script>
   ...
   function FilterData(id){
      ...
      var jenis =($('#filter_unit_user').val() == null ? '': $('#filter_unit_user').val());
      formData.append('filter_unit_user',  jenis);
      var id =(id == null ? 0: id);
         $.ajax({
    ...
    function EditData(id){
      ...
      $.ajax({
               ...
               success: function(r){
                  ...
                  $('#unit_kerja').val(json['unit_kerja']); 
...
var $dropzone = $('.image_picker'),
   ...
   $('body').on('change','#unit_user', function() {
      FilterData();
   });
</script>