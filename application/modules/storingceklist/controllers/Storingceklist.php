...
class Storingceklist extends CI_Controller{
	...
	public function index(){
		...
		$data["title"] = "Ceklis Pekerjaan";
		$data["title_des"] = " List Data Ceklis Pekerjaan";
	...
	function ProsesData($id=null){
		if (!empty($id)) {
			...
			$result = $this->Mod->update2('cheklis_storing', array('id_ceklis' => $id),$data);
	...
	function DeleteData($id=null){
        if (!empty($id)) {
			...
			$result = $this->Mod->update2('cheklis_storing', array('id_ceklis' => $id),$update);
	...
	public function LoadDataPermintaan($from=null){
		...
		$result = $this->Mod->GetCustome("SELECT * FROM sparepart_permintaan $param "); 
