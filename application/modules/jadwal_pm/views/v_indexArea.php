      ...
      <div class="modal-content">
         ...
         <form onsubmit="return SaveGroup(this)">
            <div class="modal-body p-0">
               ...
               <input id="inputFile" name="perangkat" type="file" class="d-none" onchange="setUploader(this)" accept=".xls,.xlsx"/>
...
<script>
   ...
   var end = "";
      ...
      function FilterData(){
         ...
         $.ajax({
               url: "<?=base_url()?>jadwal_pm/LoadDataArea",
               type: 'post',
               // data: formData,
               contentType: false,
               processData: false,
    ...
    function UpdateData(f){
      ...
      $.ajax({
         url:  '<?=base_url('jadwal_pm/')?>UpdateData/',
    ...
    function Upload(){
      ...
      $('#MasterIndikator').find('.modal-title').html('Upload Data ');   
    ...
    function UploadData(f){
      ...
      var formData = new FormData($(f)[0]);
      $.ajax({
         url:  '<?=base_url('jadwal_pm/')?>UploadDataArea/',
         type: 'post',
         data: formData,
         contentType: false,
         processData: false,
 ...
 Tess();
   function Tess(){
      var calendar = $('#calendar').fullCalendar({
            ...
            events:"<?php echo base_url(); ?>jadwal_pm/LoadDataArea",
            selectable:true,
            selectHelper:true,
