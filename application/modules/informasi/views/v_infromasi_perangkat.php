                                       ...
                                       <div class="row pt-10">
                                          <div class="col-md-12">
                                             ...
                                             <div class="form-group row bt-0">
                                                ...
                                                <span class="col-md-7 f-w-700 col-form-label" id="jenis">-</span>
                                             </div>
                                             <div class="form-group row">
                                                <label for="nama_fasilitas" class="col-md-5 col-form-label">Merek <span class="left-margin" >:</span></label>
                                                <span class="col-md-7 f-w-700 col-form-label" id="merk">-</span>
                                             </div>
                                             <div class="form-group row">
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <span class="col-md-7 f-w-700 col-form-label" id="garansi">-</span>
                                             </div>
                                             <div class="form-group row">
            ...
            $.ajax({
               ...
               success: function(r) {
                  ...
                  //  script untuk menampilkan data pada l  $abel perform fasilitas
                     ...
                     $('#garansi').html();
                     $('#merk').html(json['perangkat']['merk']);
                     $('#model').html(json['perangkat']['model']);
                     $('#fasilitas').html(json['perangkat']['nama_fasilitas']);
                     $('#status').html(json['perangkat']['status_label']);
                    console.log(json['perangkat']['jenis_perangkat']);
