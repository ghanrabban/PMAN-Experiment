      ...
      <div class="modal-content">
         ...
         <form onsubmit="return SaveGroup(this)">
            <div class="modal-body">
               ...
               <div class="form-group row">
                  <label class="col-sm-4 col-form-label">Nomor NKA</label>
                  <div class="col-sm-8">
               ...
               <div class="form-group row">
                  <label class="col-sm-4 col-form-label">Tanggal NKA</label>
                  <div class="col-sm-8">
                   
                     <input type="date" class="form-control" name="tanggal_nka" id="tanggal_nka" >
                  </div>
               </div>
                 <div class="form-group row">
                  <label class="col-sm-4 col-form-label">Nomor NKA(Keuangan)</label>
                  <div class="col-sm-8">
               ...
               <div class="form-group row">
                  <label class="col-sm-4 col-form-label">Nilai NKA (include PPn)</label>
                  <div class="col-sm-8">
               ...
               <div class="form-group row">
                ...
                <div class="form-group row">
                  <label class="col-sm-4 col-form-label">Nomor Kontrak(Exlude PPn)</label>
                  <div class="col-sm-8">
