                     ...
                     <div class="col-md-12">
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                                 ...
                                 <option value="UploadListPekerjaan">Upload List Pekerjaan </option>
                                 <option value="UploadJenisPerangkat">Upload Jenis Perangkat </option>
                                 <option value="UploadFasilitasTES">Tester</option>
                                 </select>
