   ...
   <body>
      <style type="text/css">
       ...
       <?php
        ...
        header("Content-Disposition: attachment; filename=Report_KPI_".$title."_".(!empty($bulan)&&!empty($$tahun)?  Fmonth($bulan).$tahun: '').".xls");
      ?>
      ...
      <h3>Realisasi Kontrak Manajemen <span style="color: #00afef"><?=$unit?></span> </h3>
      ...
      <thead>
         ...
         <tfoot>
            ...
            <tr bgcolor="#009999">
               ...
               <td ><?=substr( ($nilai/$bobot)*100, 0,5)?></td>
